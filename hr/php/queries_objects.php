...
function restaurant() {
    global $conn;
    $sql = ("SELECT a.id, n.en AS name, p.path, l.fk_city, c.name AS city FROM restaurant_pics AS p "
...
function transport() {
    global $conn;
    $sql = ("SELECT a.id, n.en AS name, p.path, l.fk_city, c.name AS city FROM transport_pics AS p "
