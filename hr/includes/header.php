                    ...
                    <div class="navbar navbar-custom">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="objects.php?section=accomm">Smještaj</a></li>
                                <li><a href="objects.php?section=beach">Plaže</a></li>
                                <li><a href="objects.php?section=restaurant">Restorani</a></li>
                                <li><a href="objects.php?section=transport">Transport</a></li>
                                <li class="dropdown" id="myServices">
                                    <a href="services.php" style="display:inline-block;padding-right:0px;">Servisi</a>
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#myServices" style="display:inline-block;padding-left:0px;">
                                      <b class="caret"></b>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="objects.php?section=beauty">Saloni</a></li>
                                        <li><a href="objects.php?section=medicine">Zdravlje</a></li>
                                        <li><a href="objects.php?section=shopping">Trgovine</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="useful_info.php">Korisne informacije</a></li>
                                        <li><a href="general_terms.php">Opći uvjeti</a></li>
                                    </ul>
                                </li>
